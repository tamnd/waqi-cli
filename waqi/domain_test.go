...
// HTTP behaviour is covered in waqi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "waqi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("waqi", "about")
	if err != nil || got.String() != "waqi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want waqi://page/about", got.String(), err)
	}
}
