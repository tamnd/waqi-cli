...
Most of these come down to network reality or how waqi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

waqi rate-limits like any public site. waqi already paces
...
Where a surface is gated, waqi reads a cookie or token you supply
...
`waqi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what waqi actually did
